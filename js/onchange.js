...
/*                   SELECCIONES DEPENDIENDO DEL TIPO DE SOCIEDAD                       */
    ...
    function tipodeSociedadOnchange(selected){
        ...
        if(selected.value == "Persona Natural" && $(".cupo").val() == "Credito"){
...
/*             CARGUE DE CONTACTOS DEPENDIENDO DE LA DIVISION SELECCIONADA              */
    ...
    function divisionOnchange(selected){
        ...
        if(selected.value == "Envases Plásticos"){
          listContacto += "<option value='Patricia Carbonell'>Patricia Carbonell</option>";
        }

        if(selected.value == "Exportaciones"){
          listContacto += "<option value='Jonathan Barreto'>Jonathan Barreto</option>";
        ...
        if(selected.value == "RoyalCondor"){
          ...
          listContacto += "<option value='Jose Ricardo Sarmiento'>Jose Ricardo Sarmiento</option>";
        ...
        if(selected.value == "Señalización"){
          listContacto += "<option value='María Nelly Betancourt'>María Nelly Betancourt</option>";
          listContacto += "<option value='Ayda Patricia Rivera'>Ayda Patricia Rivera</option>";
        }
...
function handleClick(selected){
    ...
    if(selected.value == "Crédito" && tipo_cliente.value == "Cliente Nacional" && tipo_empresa.value == "Persona Natural"){
      divCRN.style.display = ""
      divCRE.style.display = "none"
    ...
    if(selected.value == "Contado" && tipo_cliente.value == "Cliente Nacional" && tipo_empresa.value == "Persona Natural"){
      divCRN.style.display = "none"
      divCRE.style.display = "none"
      $("#rutobligatorio").prop("style", "color:green");
      $("#camaraobligatoria").prop("style", "color:green");
