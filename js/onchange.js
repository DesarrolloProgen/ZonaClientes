...
function divisionOnchange(selected) {
    ...
    if (selected.value == "RoyalCondor") {
        listContacto += "<option value='Alex Quiroz'>Alex Quiroz</option>";
        ...
        listContacto += "<option value='Steven Casso'>Steven Casso</option>";
...
function nombreContactoOnchange(selected) {
    ...
    if (selected.value == "Alex Quiroz") {
        var correo = "rc.antioquia@royalcondor.com";
        $("#emailContactoProgen").val(correo);
    }
    ...
    if (selected.value == "Jose Vargas") {
        var correo = "rc.huilacaqueta@royalcondor.com";
        $("#emailContactoProgen").val(correo);
    }
    ...
    if (selected.value == "Steven Casso") {
